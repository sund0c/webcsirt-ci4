...
$routes->group('portal-internal-x83fj9', function ($routes) {
    ...
    $routes->post('logout', 'Internal\Auth::logout');
...
$routes->group('portal-internal-x83fj9', ['filter' => 'adminauth'], function ($routes) {
    ...
    $routes->post('articles/delete/(:num)', 'Internal\Articles::delete/$1');
    $routes->get('articles/trash', 'Internal\Articles::trash');
    $routes->post('articles/restore/(:num)', 'Internal\Articles::restore/$1');
    $routes->get('articles/preview/(:segment)', 'Internal\Articles::preview/$1');
    ...
    $routes->post('advisories/delete/(:num)', 'Internal\Advisories::delete/$1');
    $routes->get('advisories/trash', 'Internal\Advisories::trash');
    $routes->post('advisories/restore/(:num)', 'Internal\Advisories::restore/$1');
    $routes->get('advisories/preview/(:segment)', 'Internal\Advisories::preview/$1');
    ...
    $routes->post('pages/delete/(:num)', 'Internal\Pages::delete/$1');
    $routes->get('pages/trash', 'Internal\Pages::trash');
    $routes->post('pages/restore/(:num)', 'Internal\Pages::restore/$1');
    ...
    $routes->post('guides/delete/(:num)', 'Internal\Guides::delete/$1');
    $routes->get('guides/trash', 'Internal\Guides::trash');
    $routes->post('guides/restore/(:num)', 'Internal\Guides::restore/$1');
    ...
    $routes->get('landing/preview/(:segment)', 'Internal\LandingSections::preview/$1');
    ...
    $routes->post('csirtbalis/delete/(:num)', 'Internal\CsirtBaliController::delete/$1');
    $routes->get('csirtbalis/trash', 'Internal\CsirtBaliController::trash');
    $routes->post('csirtbalis/restore/(:num)', 'Internal\CsirtBaliController::restore/$1');
});
...
$routes->get('media/article/(:segment)', 'MediaController::article/$1');
$routes->get('media/guide/(:segment)', 'MediaController::guide/$1');

$routes->get('panduan', 'Public\GuideController::index');
