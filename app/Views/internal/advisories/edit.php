...
<div class="max-w-3xl mx-auto bg-white p-6 rounded-xl shadow">
    ...
    <form action="<?= base_url('portal-internal-x83fj9/advisories/update/' . $advisory['id']) ?>"
        method="post"
        ...
        <?= view('components/form/textarea', [
            ...
            'label' => 'Konten',
            'rows'  => 6,
            'value' => old('content', $advisory['body'] ?? '')
        ]) ?>
        ...
        <?= view('components/form/textarea', [
            ...
            'label' => 'Excerpt',
            'rows'  => 6,
            'value' => old('excerpt', $advisory['excerpt'] ?? '')
        ]) ?>

        <?= view('components/form/input', [
            'name' => 'source_url',
            'label' => 'Sumber',
            'value' => old('source_url', $advisory['source_url'] ?? '')
        ]) ?>
        ...
        <div class="mb-4">
            ...
            <select name="status"
                ...
                <?php
                $selectedStatus = old('status', $advisory['status']);
                ?>
        ...
        <?= view('components/form/input', [
            ...
            'value' => old('image_caption', $advisory['image_caption'] ?? '')
        ]) ?>
