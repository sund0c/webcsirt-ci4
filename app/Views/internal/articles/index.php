...
<div class="bg-white rounded-xl shadow-sm p-6">
    ...
    <div class="flex justify-between items-center mb-8">
        ...
        <div class="flex items-center gap-3">
            <a href="<?= site_url('portal-internal-x83fj9/articles/create') ?>"
                class="inline-block px-3 py-2 text-xs bg-blue-600 text-white rounded hover:bg-blue-700">
                ＋ Tambah Artikel
            </a>
            <a href="<?= site_url('portal-internal-x83fj9/articles/trash') ?>"
                class="inline-block px-3 py-2 text-xs bg-red-600 text-white rounded hover:bg-red-700">Artikel Dihapus
            </a>
        ...
        <table id="dtTable" class="min-w-full text-sm border border-gray-200 rounded-lg">
            ...
            <tbody>
                <?php foreach ($articles as $article) : ?>
                    <tr>
                        <td class="px-4 py-3"><?= esc($article['title']) ?></td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex justify-center items-center space-x-3">
                                ...
                                <!-- Edit -->
                                <a href="<?= base_url('portal-internal-x83fj9/articles/edit/' . $article['id']) ?>"
                   ...
                   hover:bg-blue-700 transition duration-150">
                                ...
                                <button
                                    ...
                                    data-delete-title="<?= esc($article['title']) ?>"
                                    data-delete-url="/portal-internal-x83fj9/articles/delete/"
