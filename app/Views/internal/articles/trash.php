            ...
            <tbody class="text-sm text-gray-700 divide-y">
                <?php foreach ($articles as $article) : ?>
                    <tr>
                        ...
                        <td class="px-4 py-3">
                            <?= date('d M Y H:i', strtotime($article['deleted_at'])) ?>
                        </td>
                        <td class="px-4 py-3">
                            ...
                            <!-- Restore -->
                            <button
                                data-restore-id="<?= $article['id'] ?>"
                                data-restore-title="<?= esc($article['title']) ?>"
                                data-restore-url="/portal-internal-x83fj9/articles/restore/"
